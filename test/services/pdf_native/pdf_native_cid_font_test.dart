...
void main() {
  test('CID/Type0 font with ToUnicode CMap decodes via bfrange, but is read-only', () {
    ...
    expect(run.text, '가나');
    expect(run.isEditable, isFalse, reason: 'CID fonts cannot be re-encoded by this reader');
  });
